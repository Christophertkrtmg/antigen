...
exports.Form = exports.FormContext = exports.FormController = void 0;
...
const DefaultDef = {
    parser: new parsers_1.TextParser()
};
...
exports.FormContext = react_1.default.createContext(new FormController({}));
function Form({ controller, children }) {
    return (react_1.default.createElement(exports.FormContext.Provider, { value: controller }, children));
}
exports.Form = Form;
