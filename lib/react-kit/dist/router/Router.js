...
exports.RouterContext = exports.defaultRouter = exports.Router = void 0;
...
class Router {
    constructor(mapUrl, stackSize = 32) {
        ...
        this.effect = new EffectHandler_js_1.EffectHandler();
...
exports.RouterContext = react_1.createContext(exports.defaultRouter);
